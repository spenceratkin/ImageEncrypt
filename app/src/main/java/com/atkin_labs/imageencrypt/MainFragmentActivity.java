...
public class MainFragmentActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void dispatchTakePictureIntent() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoURI = Uri.fromFile(new File(getExternalFilesDir(Environment.DIRECTORY_PICTURES), photoFile.getName())); //FileProvider.getUriForFile(getApplicationContext(), "com.atkin_labs.imageencrypt.fileprovider", photoFile);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_gallery) {
            if (!(currentFragment instanceof GalleryFragment)) {
                ...
                mFab.setImageResource(R.drawable.ic_camera_alt_black_24dp);
                ft.commit();
            }
